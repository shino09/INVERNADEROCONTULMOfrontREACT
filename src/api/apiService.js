// // Servicio de API que conecta con el backend .NET en el puerto 5090 para oracle
const API = "http://localhost:5090/api";

// Servicio de API que conecta con el backend .NET en el puerto 5091 para postgre
